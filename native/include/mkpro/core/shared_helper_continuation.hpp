...
// is intentionally analysis-only: moving the continuation before the helper's
// return would change the divergent call until a physical dual-mode layout is
// committed.  natural_component_layout consumes this certificate and performs
// the whole rewrite transactionally.
SharedHelperContinuationProof
