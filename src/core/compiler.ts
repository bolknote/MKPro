...
const optimizerCapabilities: Array<{
  ...
  },
  {
    ...
    detail: "Uses compiler-marked ВП cells where they simultaneously restore X2 and provide the needed fractional/mantissa side effect, including X-preserving store/empty/marker/direct-return gaps before redundant К {x}; also collapses redundant ВП ВП, empty-op runs before ВП, and proved exponent /-/ /-/ toggles.",
  },
  {
    id: "x2-hidden-temp",
    category: "stack",
