...
Ответ в R0 (1), RA (7), RB (-1). ПМК сделал ход B2-A3: 51555555 хП1; 55515151 хП2. После ответа чёрных передаём ход ПМК: устанавливаем нужное RД, 2 (3 или 4) хП0; 0.6 хП6 (т.к. X=7 - нечётное) и С/П (вместо контроля R6 можно запускать программу с адреса 04 (командой БП 04 С/П), но тогда поиск хода начнётся с X=RA, т.е. с 7 вертикали).
