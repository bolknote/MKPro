...
This short utility computes planetary gravity from radius and an empirical constant.
In the issue text it is used by the landing games and the `Guess Gravity` activity to create
