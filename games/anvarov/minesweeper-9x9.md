...
При начальном вводе количества мин, если число содержит дробную часть, то она будет проигнорирована (отброшена). Если число не в диапазоне 1&hellip;63, то выдаст ЕГГ0Г . В этом случае нужно заново ввести правильное число, затем В/О С/П.
