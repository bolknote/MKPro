...
- Source: [xbasoft PMK package](https://xvadim.github.io/xbasoft/pmk/mem_training2.zip)
...
Nearest existing listing during import audit: `games/memory-training-1m.txt` (28.6% similarity, edit distance 75).
