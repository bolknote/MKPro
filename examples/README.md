...
- Pending optimizer: 6 programs still exceed the MK-61 window; nearest is `pending-optimizer/cave-highlevel-baseline.mkpro` (130).
...
| `cave-sketch.mkpro` | 54 | 105 | -51 | ok: <= reference | main+setup load ok |
...
Out of MK-61 registers while allocating 'visited_vaults'.
Unknown variable 'vaults'
Unknown variable 'visited_vaults'
Unknown variable 'visited_vaults'
