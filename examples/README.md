...
- Pending optimizer: 6 programs still exceed the MK-61 window; nearest is `pending-optimizer/labyrinth777.mkpro` (163).
...
| `pending-optimizer/cave-highlevel-baseline.mkpro` | 194 | 105 | +89 | pending optimizer | setup load ok; main >105 |
