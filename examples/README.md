...
| `basic.mkpro` | 7 | - | - | ok: no reference | load ok |
| `cave-highlevel-baseline.mkpro` | 103 | 105 | -2 | ok: <= reference | main+setup load ok |
| `cave-sketch.mkpro` | 38 | 105 | -67 | ok: <= reference | main+setup load ok |
| `cave-treasure.mkpro` | 103 | 105 | -2 | ok: <= reference | main+setup load ok |
| `clock.mkpro` | 30 | 63 | -33 | ok: <= reference | main+setup load ok |
...
| `jack-pot.mkpro` | 94 | 999999 | -999905 | ok: <= reference | main+setup load ok |
| `labyrinth777.mkpro` | 105 | 105 | 0 | ok: <= reference | main+setup load ok |
| `lunar.mkpro` | 44 | 999999 | -999955 | ok: <= reference | load ok |
| `minesweeper-9x7.mkpro` | 76 | 999999 | -999923 | ok: <= reference | main+setup load ok |
| `minesweeper-9x9.mkpro` | 76 | 97 | -21 | ok: <= reference | main+setup load ok |
| `raja-yoga.mkpro` | 77 | 98 | -21 | ok: <= reference | main+setup load ok |
| `rambo-iii.mkpro` | 103 | 999999 | -999896 | ok: <= reference | load ok |
| `river-battle.mkpro` | 90 | - | - | ok: no reference | main+setup load ok |
