...
- Pending optimizer: 1 program still exceeds the MK-61 window; nearest is `pending-optimizer/tic-tac-toe-4x4.mkpro` (151).
...
| `pending-optimizer/tic-tac-toe-4x4.mkpro` | 151 | 105 | +46 | pending optimizer | not loaded: main >105 |
