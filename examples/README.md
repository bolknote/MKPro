...
| `alaram.mkpro` | 83 | 105 | -22 | ok: <= reference | load ok |
...
| `pending-optimizer/giants-country.mkpro` | 181 | 105 | +76 | pending optimizer | setup load ok; main >105 |
...
| `pending-optimizer/tic-tac-toe-4x4.mkpro` | 246 | 105 | +141 | pending optimizer | not loaded: main >105 |
| `pending-optimizer/treasure-hunter-2.mkpro` | 150 | 105 | +45 | pending optimizer | setup load ok; main >105 |
