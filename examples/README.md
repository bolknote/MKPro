...
- Pending optimizer: 1 programs still exceed the MK-61 window; nearest is `pending-optimizer/tic-tac-toe-4x4.mkpro` (302).
...
| `minesweeper-9x7.mkpro` | 85 | 104 | -19 | ok: <= reference | main+setup load ok |
...
| `pending-optimizer/tic-tac-toe-4x4.mkpro` | 302 | 105 | +197 | pending optimizer | not loaded: main >105 |
