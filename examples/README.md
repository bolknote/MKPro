...
- Pending optimizer: 1 program still exceeds the MK-61 window; nearest is `pending-optimizer/tic-tac-toe-4x4.mkpro` (166).
...
| `pending-optimizer/tic-tac-toe-4x4.mkpro` | 166 | 105 | +61 | pending optimizer | not loaded: main >105 |
