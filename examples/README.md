...
- Pending optimizer: 8 programs still exceed the MK-61 window; nearest is `pending-optimizer/cave-highlevel-baseline.mkpro` (120).
...
| `pending-optimizer/jack-pot.mkpro` | 99 | 104 | -5 | ok: <= reference | main+setup load ok |
