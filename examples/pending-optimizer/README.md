...
| `tic-tac-toe-4x4.mkpro` | 313 | 105 | fresh high-level packed-line port; remaining blockers are shared line-update/check lowering and dynamic calculator-win display composition |
