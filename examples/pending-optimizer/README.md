...
| --- | ---: | ---: | --- |
| `cave-highlevel-baseline.mkpro` | 250 | 105 | command dispatch and cave mask lowerers |
| `cave-treasure.mkpro` | 291 | 105 | command dispatch, guarded direction dispatch, and cave mask lowerers |
| `giants-country.mkpro` | 212 | 105 | remaining encounter dispatch and plan bitset lowerers |
...
| `tic-tac-toe-4x4.mkpro` | 278 | 105 | 4x4 line-count state representation |
