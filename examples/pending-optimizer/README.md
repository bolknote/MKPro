...
| `cave-treasure.mkpro` | 294 | 105 | command dispatch, guarded direction dispatch, and cave mask lowerers |
| `giants-country.mkpro` | 225 | 105 | remaining encounter dispatch and plan bitset lowerers |
...
| `tic-tac-toe-4x4.mkpro` | 295 | 105 | 4x4 line-count state representation |
