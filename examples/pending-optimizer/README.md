...
| --- | ---: | ---: | --- |
| `cave-highlevel-baseline.mkpro` | 128 | 105 | command dispatch and remaining cave flow lowerers |
| `cave-treasure.mkpro` | 149 | 105 | guarded direction dispatch, wall breaking, and cache flow |
