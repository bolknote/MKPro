...
| --- | ---: | ---: | --- |
| `cave-highlevel-baseline.mkpro` | 127 | 105 | command dispatch and remaining cave flow lowerers |
| `cave-treasure.mkpro` | 148 | 105 | guarded direction dispatch, wall breaking, and cache flow |
