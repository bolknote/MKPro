...
const LOWERING_VARIANTS: ReadonlyArray<{ name: string; options: Record<string, unknown> }> = [
  ...
  { name: "repeatedUnaryUpdateArgTemp", options: { canonicalizeRepeatedUnaryUpdateArgs: true } },
  { name: "xParamValueFunction", options: { xParamValueFunctions: true } },
  { name: "xParamValueFunction+repeatedUnaryUpdateArgTemp", options: { xParamValueFunctions: true, canonicalizeRepeatedUnaryUpdateArgs: true } },
  { name: "xParamValueFunction+repeatedUnaryUpdateArgTemp+coalesceCopies", options: { xParamValueFunctions: true, canonicalizeRepeatedUnaryUpdateArgs: true, coalesceCopies: true } },
