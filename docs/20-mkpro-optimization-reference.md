...
- `x2-register-dataflow` — tracks definite states of the form “X2 currently
  ...
  unary or closed-context stable expression key, so repeated pure operations
